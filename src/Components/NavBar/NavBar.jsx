...
const NavBar = () => {
    ...
    return (
        <div className="navbar bg-base-100 shadow-sm px-4 md:px-6 lg:px-8 xl:px-12 py-3 border-b border-base-200">
            ...
            <div className="navbar-end gap-3">
                ...
                <Link href="#" className="hidden lg:flex items-center gap-2 px-5 py-2.5 bg-primary text-white rounded-xl font-semibold text-sm hover:bg-primary/90 transition duration-150">
                ...
                <div className="dropdown dropdown-end lg:hidden">
                    ...
                    >
                        {/* Map over the navigation links */}
                        {navLinks}
                        
                        {/* Divider for aesthetic separation inside mobile menu */}
                        <div className="divider my-1"></div>
                        
                        {/* Mobile Contribute Button inside the menu */}
                        <li>
                            <Link href="#" className="flex justify-center items-center gap-2 px-4 py-2.5 bg-primary text-white rounded-lg font-semibold w-full hover:bg-primary/90 text-center active:text-white">
                                <FaGithub className="text-lg" />
                                Contribute
                            </Link>
                        </li>
